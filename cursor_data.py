...
#
# 4) Read and save cursor positiondata to a .csv file in the local directory
"""
...
if __name__ == '__main__':
    ...
    for date, files in bag_file_list.items():
        ...
        temp_df = agent.get_topic_data('/cursor/position')
        csv_file_name = date.replace('/','_') + '_CURSOR_POS.csv'
        temp_df.to_csv(csv_file_name)